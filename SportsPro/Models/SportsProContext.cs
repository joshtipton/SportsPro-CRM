...
namespace SportsPro.Models
{
    public class SportsProContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Registration>().HasKey(r => new { r.ProductID, r.CustomerID });
            modelBuilder.Entity<Registration>().HasOne(r => r.CurrentProduct).WithMany(r => r.Registrations).HasForeignKey(r => r.CustomerID);
            modelBuilder.Entity<Registration>().HasOne(r => r.CurrentCustomer).WithMany(r => r.Registrations).HasForeignKey(r => r.ProductID);
